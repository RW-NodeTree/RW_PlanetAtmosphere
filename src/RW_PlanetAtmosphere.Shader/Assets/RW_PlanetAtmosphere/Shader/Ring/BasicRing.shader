    ...
    SubShader {
        ...
        Pass {
            ...
            f2bShadowTrans frag (v2f i)
            {
                ...
                float4 clipSpacePos = UnityWorldToClipPos(fargPos + i.worldSpaceZeroPoint);
                o.shadowTransFactor = lerp(1.0 - color.w, 1.0, saturate(max(length(fargPos) / maxDistance, 0)));
        ...
        Pass {
            ...
            f2bShadowTrans frag (v2f i)
            {
                ...
                o.shadowTransFactor = 1.0-color.w;

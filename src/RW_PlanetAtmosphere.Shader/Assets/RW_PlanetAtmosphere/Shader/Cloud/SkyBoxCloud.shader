    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            f2bShadowTrans frag (v2f i)
            {
                ...
                float4 clipSpacePos = UnityWorldToClipPos(fargPos);
                o.shadowTransFactor.xyz = lerp(1.0,1.0 - cloudColorA.w,cloudPosA.w) * lerp(1.0,1.0 - cloudColorB.w,cloudPosB.w);
        ...
        Pass
        {
            ...
            f2bShadowTrans frag (v2f i)
            {
                ...
                o.shadowTransFactor = lerp(1.0,1.0 - cloudColorA.w,cloudPosA.w);
        ...
        Pass
        {
            ...
            f2bShadowTrans frag (v2f i)
            {
                ...
                o.shadowTransFactor = lerp(1.0,1.0 - cloudColorB.w,cloudPosB.w);
